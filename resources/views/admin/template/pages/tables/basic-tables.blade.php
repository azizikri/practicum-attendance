        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-3 text-muted">Add class <code>.table</code></p>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-3 text-muted">Add class <code>.table-hover</code></p>
                    <div class="table-responsive">
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-3 text-muted">Add class <code>.table-bordered</code></p>
